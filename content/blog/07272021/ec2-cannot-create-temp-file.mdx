...
There you are: `/dev/xda1` is full `99%`, normally this is the main mount partition where most of the user's data are located.

Let's check sort out top 20 files with heaviest sizes and purge them:
...
My `/dev/xda1` was freed, I returned the available spaces to my instances. Mission success!
